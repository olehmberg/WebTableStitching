...
public class Movies_DuplicateDetection_Main {
	...
	public static String pathToThisJarWithDependencies = "file://C:/Users/Sanikumar/Desktop/DataIntegrationFramework.Spark/target/DataIntegrationFramework.Spark-0.0.1-SNAPSHOT-jar-with-dependencies.jar";
	public static String sparkMaster = "spark://lski-014.informatik.uni-mannheim.de:7077";
	public static String applicationName = "WDI: Movies Duplicate Detection";
...
//		SparkBlocker<Movie, DefaultSchemaElement> blocker = new SparkStandardBlocker<>(
//				new StaticBlockingKeyGenerator<Movie>());
		Blocker<Movie, DefaultSchemaElement> blocker = new StandardBlocker<>(new StaticBlockingKeyGenerator<Movie>());

...
public class SparkSchemaMatchingFunction<RecordType extends Matchable, SchemaElementType extends Matchable> implements Function<Correspondence<RecordType, SchemaElementType>, ResultSet<Correspondence<SchemaElementType, RecordType>>> {
	...
	@Override
	public ResultSet<Correspondence<SchemaElementType, RecordType>> call(
			Correspondence<RecordType, SchemaElementType> arg0) throws Exception {
		return rule.apply(schema1, schema2, arg0);
	}

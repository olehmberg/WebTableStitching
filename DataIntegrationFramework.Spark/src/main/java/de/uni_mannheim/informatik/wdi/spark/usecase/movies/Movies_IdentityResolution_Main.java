 ...
 *
 */
package de.uni_mannheim.informatik.wdi.spark.usecase.movies;
...
public class Movies_IdentityResolution_Main {
	...
	public static String pathToThisJarWithDependencies = "file://C:/data/workspaces/Web%20Data%20Integration/DataIntegrationFramework.Spark/target/DataIntegrationFramework.Spark-0.0.1-SNAPSHOT-jar-with-dependencies.jar";
	public static String sparkMaster = "spark://lski-014:7077";
	public static String applicationName = "WDI: Movies Identity Resolution";
...
//		SparkBlocker<Movie, DefaultSchemaElement> blocker = new SparkNoBlocker<>();
		Blocker<Movie, DefaultSchemaElement> blocker = new NoBlocker<>();

		// Initialize Matching Engine
		MatchingEngine<Movie, DefaultSchemaElement> engine = new SparkMatchingEngine<>(sc);
	...
	public static void firstMatching() throws Exception {
		...
		// Initialize Matching Engine
		SparkMatchingEngine<Movie, DefaultSchemaElement> engine = new SparkMatchingEngine<>(sc);
	...
	private static void printCorrespondences(
		...
		// sorting is not supported by the list that is returned from spark ...
		correspondences = new ArrayList<>(correspondences);

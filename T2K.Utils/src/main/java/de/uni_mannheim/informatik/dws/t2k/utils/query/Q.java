...
public class Q {
    ...
    /**
     * Returns the object from the collection with the highest value according to the valueSelector function
     * @param data
     * @param valueSelector
     * @return
     */
    ...
    /**
     * Returns the object from the collection with the lowest value according to the valueSelector function
     * @param data
     * @param valueSelector
     * @return
     */

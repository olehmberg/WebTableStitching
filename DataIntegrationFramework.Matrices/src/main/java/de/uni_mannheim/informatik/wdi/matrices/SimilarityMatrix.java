...
import de.uni_mannheim.informatik.dws.t2k.utils.data.Triple;
...
public abstract class SimilarityMatrix<T> {
    ...
    /**
     * returns the list of all objects in the first dimension (passed as 'first'
    ...
    /**
     * returns the list of all objects in the second dimension (passed as
     * 'second' parameter to the set() method)
     * 
     * @return
     */
    ...
    /**
     * returns all objects in the second dimension that have a similarity >
     * similarityThreshold
     * 
     * @param first
    ...
    /**
     * returns the label of an instance that is part of the first or second
     * dimension
     * 
     * @param instance
     * @return
...
//        int colWidth = 20;
    ...
    public <U> Collection<Correspondence<T, U>> toCorrespondences() {
    ...
    public static <T, U> SimilarityMatrix<T> fromCorrespondences(Collection<Correspondence<T, U>> correspondences, SimilarityMatrixFactory factory) {

...
import de.uni_mannheim.informatik.dws.t2k.match.blocking.KeyIndexLookup;
...
public class IndexTest extends TestCase {
	/**
	 * Test method for {@link de.uni_mannheim.informatik.dws.t2k.index.dbpedia.DBpediaIndexer#indexInstances(de.uni_mannheim.informatik.dws.t2k.index.IIndex, java.util.Collection, java.util.Map, de.uni_mannheim.informatik.dws.t2k.match.data.SurfaceForms)}.
	...
	public void testIndexInstanceandSearchMany(){
		DataSet<MatchableTableRow, MatchableTableColumn> dataset = new DefaultDataSet<>();

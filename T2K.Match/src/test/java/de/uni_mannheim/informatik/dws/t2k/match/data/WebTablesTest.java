...
public class WebTablesTest extends TestCase {
	...
	/**
	 * Test method for {@link de.uni_mannheim.informatik.dws.t2k.match.data.WebTables#loadWebTables(java.io.File, boolean, boolean)}
	 * @throws IOException 
	 * @throws URISyntaxException 
	 */
	public void testLoadWebTables() throws IOException, URISyntaxException{
		WebTables wb = new WebTables();
		File ser = new File("src\\test\\resources\\webtables.bin");
		if(ser.exists()) {
			ser.delete();
		}
		wb = WebTables.loadWebTables(new File("src\\test\\resources\\webtables\\"), false, true, false);

...
public class CandidateSelectionRuleTest extends TestCase {
	/**
	 * Test method for {@link de.uni_mannheim.informatik.dws.t2k.match.rules.CandidateSelectionRule#apply(MatchableTableRow, MatchableTableRow, de.uni_mannheim.informatik.wdi.model.ResultSet)}
	 */
...
//		create the comparator and add it to the rule
		...
		assertNotNull(rule1.apply(r1, r2, schemaCorrespondence));
		assertNull(rule1.apply(r3, r4, schemaCorrespondence));
...
//		create the comparator and add it to the rule
		...
		assertNotNull(rule2.apply(r1, r3, schemaCorrespondence));
		assertNull(rule2.apply(r1, r2, schemaCorrespondence));
		assertNull(rule2.apply(r3, r4, schemaCorrespondence));

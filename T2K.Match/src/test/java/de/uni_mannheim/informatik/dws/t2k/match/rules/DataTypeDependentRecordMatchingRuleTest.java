...
//	}
	...
	/**
	 * Test method for {@link de.uni_mannheim.informatik.dws.t2k.match.rules.DataTypeDependentRecordMatchingRule#apply(MatchableTableRow, MatchableTableRow, ResultSet)}
	 */
...
//		create schema correspondence
		...
		ResultSet<Correspondence<MatchableTableColumn, MatchableTableRow>> schemaCorrespondence = new ResultSet<>();
...
//		check for return value of rule
		assertNotNull(rule1.apply(wr1, kr1, schemaCorrespondence));
		assertNull(rule1.apply(wr1, kr2, schemaCorrespondence));
		assertNull(rule1.apply(wr2, kr1, schemaCorrespondence));
...
//		check for return value of rule
		assertNotNull(rule2.apply(wr1, kr1, schemaCorrespondence));
		assertNotNull(rule2.apply(wr1, kr2, schemaCorrespondence));
		assertNull(rule2.apply(wr2, kr1, schemaCorrespondence));

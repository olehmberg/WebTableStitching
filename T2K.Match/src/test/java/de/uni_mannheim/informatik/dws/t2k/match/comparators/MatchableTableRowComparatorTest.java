...
public class MatchableTableRowComparatorTest extends TestCase {
	/**
	 * Test method for {@link de.uni_mannheim.informatik.dws.t2k.match.comparators.MatchableTableRowComparator#compare(MatchableTableRow, MatchableTableRow, int, int)}.
	 */
...
//		assertEquals(0.25, cmp2.compare(r1, r2, 0, 0));
	...
	/**
	 * Test method for {@link de.uni_mannheim.informatik.dws.t2k.match.comparators.MatchableTableRowComparator#canCompareRecords(MatchableTableRow, MatchableTableRow, int, int)}.
	 */

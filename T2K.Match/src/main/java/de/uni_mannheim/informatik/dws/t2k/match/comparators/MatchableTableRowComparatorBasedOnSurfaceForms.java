...
//	bracketPattern is used remove a bracket including everything inside the bracket. for example, 'Republic Party (USA)' -> 'Republic Party'  
	...
	/**(non-Javadoc)
	 * @see de.uni_mannheim.informatik.dws.t2k.match.comparators.MatchableTableRowComparator#canCompareRecords(MatchableTableRow, MatchableTableRow, int, int)
	 */
	...
	/** (non-Javadoc)
	 * @see de.uni_mannheim.informatik.dws.t2k.match.comparators.MatchableTableRowComparator#compare(MatchableTableRow, MatchableTableRow, int, int)
	 */

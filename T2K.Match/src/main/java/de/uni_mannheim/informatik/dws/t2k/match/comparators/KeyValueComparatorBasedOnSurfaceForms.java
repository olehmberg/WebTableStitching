...
public class KeyValueComparatorBasedOnSurfaceForms extends Comparator<MatchableTableRow, MatchableTableColumn>{
...
//	surface form
	...
	/** (non-Javadoc)
	 * @see de.uni_mannheim.informatik.wdi.matching.Comparator#compare(java.lang.Object, java.lang.Object, de.uni_mannheim.informatik.wdi.model.ResultSet)
	 * 
	 * @param schemaCorrespondences 
	 *						here it must not be null
	 */
	@Override
...
//		TODO: if necessary remove the text inside the bracket (like in 'MatchableTableRowComparatorBasedOnSurfaceForms' comparator)

...
import de.uni_mannheim.informatik.dws.t2k.index.dbpedia.DBPediaInstanceIndex;
import de.uni_mannheim.informatik.dws.t2k.index.dbpedia.DBpediaIndexEntry;
...
//        idx.setMaxEditDistance(2);
	...
	//				matches = idx.search((String)lbl, DBpediaIndexEntry.CLASS_LABEL_FIELD, classesPerTable.get(tableId));
					matches = idx.searchMany(lbls,DBpediaIndexEntry.CLASS_LABEL_FIELD, classesPerTable.get(tableId));
				} else {
	//				matches = idx.search((String)lbl); 

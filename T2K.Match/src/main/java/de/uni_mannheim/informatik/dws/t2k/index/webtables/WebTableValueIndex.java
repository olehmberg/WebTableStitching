...
import de.uni_mannheim.informatik.dws.t2k.index.io.StringNormaliser;
import de.uni_mannheim.informatik.dws.t2k.index.management.IndexManagerBase;
...
public class WebTableValueIndex extends IndexManagerBase {
   ...
   public List<WebTableIndexEntry> searchMany(Collection<String> labels) {
            ...
            if(q!=null) {
                ...
                if(hits != null)
                {
                    ...
                    for (int i = 0; i < hits.length; i++) {
                        ...
                        if(isVerbose()) {
                            System.out.println(e.getTable() + ": " + e.getColumn() + ": " + e.getRow());
                        }

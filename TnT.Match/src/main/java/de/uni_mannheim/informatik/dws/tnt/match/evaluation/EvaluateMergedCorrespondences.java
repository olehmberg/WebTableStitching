...
//					perf.getF1()));
		...
		ResultSet<Correspondence<MatchableTableColumn, MatchableTableColumn>> result = new ResultSet<>(); 
		...
		if(transformedLocation!=null) {
			...
			MatchingEngine<MatchableTableRow, MatchableTableColumn> me = new MatchingEngine<>();
			me.writeCorrespondences(result.get(), transformedFile);
		}

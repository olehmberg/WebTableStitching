 ...
 * 
 */
public class DateFuserFavourSource extends AttributeValueFuser<DateTime, Movie, DefaultSchemaElement> {

	public DateFuserFavourSource() {
		super(new FavourSources<DateTime, Movie, DefaultSchemaElement>());
	}

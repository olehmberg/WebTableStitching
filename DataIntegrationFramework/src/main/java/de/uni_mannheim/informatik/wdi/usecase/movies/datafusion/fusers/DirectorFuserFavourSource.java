 ...
 * 
 */
public class DirectorFuserFavourSource extends AttributeValueFuser<String, Movie, DefaultSchemaElement> {

	public DirectorFuserFavourSource() {
		super(new FavourSources<String, Movie, DefaultSchemaElement>());
	}

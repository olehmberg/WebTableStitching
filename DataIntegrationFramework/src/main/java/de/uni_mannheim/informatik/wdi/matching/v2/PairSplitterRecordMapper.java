 ...
 *
 */
public class PairSplitterRecordMapper<FirstType, SecondType> implements RecordMapper<Pair<FirstType, SecondType>, SecondType> {
	 ...
	 */
	@Override
	public void mapRecord(Pair<FirstType, SecondType> record, DatasetIterator<SecondType> resultCollector) {
